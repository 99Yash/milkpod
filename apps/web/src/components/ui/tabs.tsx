...
const navTabVariants = cva(
  'relative cursor-pointer rounded-lg px-3.5 py-1.5 text-sm transition-colors outline-none',
  {
    variants: {
      active: {
        true: 'font-medium text-foreground border border-border',
        false: 'text-muted-foreground border border-transparent hover:text-foreground/80 hover:border-border/50',
      },
    },
    defaultVariants: {
      active: false,
