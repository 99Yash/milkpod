...
- `REDIS_URL` - Optional Redis connection string; enables BullMQ durable job queue and Redis pub/sub SSE events. Without this, pipelines run fire-and-forget in-process.
